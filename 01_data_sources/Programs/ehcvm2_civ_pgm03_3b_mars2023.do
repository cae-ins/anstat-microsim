...
*               Seuils de pauvreté et indicateurs - Approche 3, Variante b    *
...
capture log close
log using "$prog\ehcvm_${pays}_pgm03b.log", replace text   

***********
** On utilise trois approches pour le seuil 2021, et pour chaque approche deux variantes
** Ce do-file traite de la troisième approche et de sa première variante
** Approche 3: Construction du seuil de 2021 avec panier de 2018 valorisé aux prix de 2021
...
dis ind18  /* produits communs font 75% conso 2021 et 32% conso 2018 */
* 
*
...
use "$dataout_temp\ehcvm_panier2018_code2021.dta", clear  /* Partir du panier de conso */
...
gen pmn=vunag_med_2018  // Utiliser prix 2018 pour dériver quantités de 2018 
...
gen conso_pc_val_up=conso_pc_qte_up*pmn*365/10 // Valoriser quantités 2018 aux prix de 2021 
gen all=1
