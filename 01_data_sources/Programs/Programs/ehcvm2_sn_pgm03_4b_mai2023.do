...
*               Seuils de pauvreté et indicateurs - Approche 4, Variante b    *
...
capture log close
log using "$prog\ehcvm_${pays}_pgm04b.log", replace text   
***********
** On utilise Quatre approches pour le seuil 2021, et pour chaque approche deux variantes
** Ce do-file traite de la quatrième approche et de sa seconde variante
** Approche 4: Seuil de 2021 avec panier de 2018, conso 2021 valorisé aux prix de 2021
** Variante b: les déflateurs temporels sont calculés du volet prix de l'EHCVM 
** Les déflateurs spatiaux: ceux calculés du volet prix de l'EHCVM  
***********
*
*
...
/* Exclure ci-dessous les produits "autres", et aussi thé et café, imprécis sur prix et calories */
...
/*  Comme en 2b, pb pour les seuils non-alimentaires et avec les prix
	2021	2018	Evolution
...
compress
sort hhid 
save "$dataout\ehcvm_welfare_3b_${pays}.dta", replace
