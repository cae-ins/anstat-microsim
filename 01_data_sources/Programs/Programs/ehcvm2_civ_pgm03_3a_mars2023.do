...
*               Seuils de pauvreté et indicateurs - Approche 3, Variante a    *
...
capture log close
log using "$prog\ehcvm_${pays}_pgm03a.log", replace text   
...
dis ind21
gen ind18=depant18t/depan_tot_2018
dis ind18  /* produits communs font 85% conso 2021 et 77% conso 2018 */
*
*
******************** Population de référence pour le seuil *********************
*
use "$dataout_temp\ehcvm_men_temp.dta", clear  /* Population decile 3 a 8 */
