...
********************************************************************************
* STEP 12 — Poverty incidence
********************************************************************************

di as text "--------------------------------------------------"
di as text "STEP 12 : Poverty incidence (FGT)"
di as text "--------------------------------------------------"

capture noisily do "$CODE/12_poverty_incidence.do"
if _rc != 0 {
    di as error "❌ ERROR in 12_poverty_incidence.do"
    exit 1
}
